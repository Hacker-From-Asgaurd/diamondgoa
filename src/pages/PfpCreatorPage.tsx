...
export const PfpCreatorPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#03502E] text-white flex flex-col font-sans selection:bg-[#FF007A] selection:text-white">
      ...
      <div className="w-full bg-[#023D23] border-b border-emerald-800/40 py-4 px-6 sm:px-12 select-none">
      ...
      {/* Minimal Footer */}
      <footer className="w-full border-t border-[#023D23] bg-[#023D23] py-6 mt-auto">
        <div className="max-w-6xl mx-auto px-4 text-center font-mono text-xs text-zinc-400">
